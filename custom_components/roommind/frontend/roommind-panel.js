...
`,at="M11.83,9L15,12.16C15,12.11 15,12.05 15,12A3,3 0 0,0 12,9C11.94,9 11.89,9 11.83,9M7.53,9.8L9.08,11.35C9.03,11.56 9,11.77 9,12A3,3 0 0,0 12,15C12.22,15 12.44,14.97 12.65,14.92L14.2,16.47C13.53,16.8 12.79,17 12,17A5,5 0 0,1 7,12C7,11.21 7.2,10.47 7.53,9.8M2,4.27L4.28,6.55L4.73,7C3.08,8.3 1.78,10 1,12C2.73,16.39 7,19.5 12,19.5C13.55,19.5 15.03,19.2 16.38,18.66L16.81,19.08L19.73,22L21,20.73L3.27,3M12,7A5,5 0 0,1 17,12C17,12.64 16.87,13.26 16.64,13.82L19.57,16.75C21.07,15.5 22.27,13.86 23,12C21.27,7.61 17,4.5 12,4.5C10.6,4.5 9.26,4.75 8,5.2L10.17,7.35C10.74,7.13 11.35,7 12,7Z";function xe(e){var t,i;return((i=(t=e.config)==null?void 0:t.unit_system)==null?void 0:i.temperature)==="°F"}function v(e){return xe(e)?"°F":"°C"}function R(e,t){return xe(t)?e*9/5+32:e}function ne(e,t){return xe(t)?(e-32)*5/9:e}function W(e,t){return xe(t)?e*9/5:e}function E(e,t,i=1){return R(e,t).toFixed(i)}function Y(e){return xe(e)?"1":"0.5"}function z(e,t,i){return{min:String(Math.round(R(e,i))),max:String(Math.round(R(t,i)))}}var It=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,Z=(e,t,i,s)=>{for(var o=s>1?void 0:s?Nt(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&It(t,i,o),o};let U=class extends N{constructor(){super(...arguments),this.config=null,this.climateEntityCount=0,this.tempSensorCount=0,this.controlMode="bangbang",this.climateControlActive=!0,this.reordering=!1,this.canMoveUp=!1,this.canMoveDown=!1}render(){var c,d,p,m,g,b,S;const e=this.climateEntityCount>0,t=(((d=(c=this.config)==null?void 0:c.thermostats)==null?void 0:d.length)??0)>0||(((m=(p=this.config)==null?void 0:p.acs)==null?void 0:m.length)??0)>0,i=this.config!==null&&t,s=(g=this.config)==null?void 0:g.live,o=s==null?void 0:s.mode,a=!i&&s&&(s.current_temp!==null||s.current_humidity!==null),r=i?o==="heating"?"accent-heating":o==="cooling"?"accent-cooling":"accent-idle":a?"accent-idle":"accent-unconfigured";return l`
      <ha-card
      ...
      >
        ...
        <div class="card-inner">
          <div class="card-header">
            <h3 class="area-name">${((b=this.config)==null?void 0:b.display_name)||this.area.name}</h3>
            ${i&&s?l`
    ...
    `}_renderConfigured(){var i;const e=(i=this.config)==null?void 0:i.live;if(!e)return l`<div class="waiting">${n("card.waiting",this.hass.language)}</div>`;const t=this.controlMode==="mpc";return l`
      <div class="temp-section">
        ${e.current_temp!==null?l`
              ...
              <span class="temp-unit">${v(this.hass)}</span>
      ...
      <div class="card-footer">
        ...
        <span class="badge-row">
          ...
          ${e.mold_prevention_active?l`<span class="mold-badge prevention">
                ...
                ${n("card.mold_prevention",this.hass.language,{delta:W(e.mold_prevention_delta,this.hass).toFixed(0),unit:v(this.hass)})}
              </span>`:h}
    ...
    `}_renderTargetInfo(e){var o;if(e.target_temp===null&&e.heat_target===null)return h;const s=(((o=this.config)==null?void 0:o.climate_mode)??"auto")==="auto"&&e.heat_target!=null&&e.cool_target!=null&&e.heat_target!==e.cool_target?l`<span class="target-value">${E(e.heat_target,this.hass)} – ${E(e.cool_target,this.hass)}${v(this.hass)}</span>`:l`<span class="target-value">${E(e.target_temp??e.heat_target,this.hass)}${v(this.hass)}</span>`;return l`
    ...
    `}_onCardClick(){this.dispatchEvent(new CustomEvent("area-selected",{detail:{areaId:this.area.area_id},bubbles:!0,composed:!0}))}_onMoveUp(e){e.stopPropagation(),this.canMoveUp&&this.dispatchEvent(new CustomEvent("move-room-up",{detail:{areaId:this.area.area_id},bubbles:!0,composed:!0}))}_onMoveDown(e){e.stopPropagation(),this.canMoveDown&&this.dispatchEvent(new CustomEvent("move-room-down",{detail:{areaId:this.area.area_id},bubbles:!0,composed:!0}))}_onHideClick(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent("hide-room",{detail:{areaId:this.area.area_id},bubbles:!0,composed:!0}))}};U.styles=[nt,j`
    :host {
      display: block;
    }
  ...
  `],Z([_({attribute:!1})],U.prototype,"area",2),Z([_({attribute:!1})],U.prototype,"config",2),Z([_({type:Number})],U.prototype,"climateEntityCount",2),Z([_({type:Number})],U.prototype,"tempSensorCount",2),Z([_({attribute:!1})],U.prototype,"hass",2),Z([_({type:String})],U.prototype,"controlMode",2),Z([_({type:Boolean})],U.prototype,"climateControlActive",2),Z([_({type:Boolean})],U.prototype,"reordering",2),Z([_({type:Boolean})],U.prototype,"canMoveUp",2),Z([_({type:Boolean})],U.prototype,"canMoveDown",2),U=Z([Q("rs-area-card")],U);var Wt=Object.defineProperty,Ut=Object.getOwnPropertyDescriptor,X=(e,t,i,s)=>{for(var o=s>1?void 0:s?Ut(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Wt(t,i,o),o};const Ft="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z",Vt="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z";let G=class extends N{constructor(){super(...arguments),this.config=null,this.climateControlActive=!0,this.overrideInfo=null,this._countdown="",this._editingName=!1,this._nameInput=""}disconnectedCallback(){super.disconnectedCallback(),this._clearCountdownTimer()}updated(e){(e.has("overrideInfo")||e.has("config"))&&this._updateCountdown()}_clearCountdownTimer(){this._countdownTimer&&(clearInterval(this._countdownTimer),this._countdownTimer=void 0)}_getOverrideUntil(){var e;return(e=this.overrideInfo)!=null&&e.active?this.overrideInfo.until:null}_updateCountdown(){if(this._clearCountdownTimer(),!this._getOverrideUntil()){this._countdown="";return}const t=()=>{const i=this._getOverrideUntil();if(!i){this._countdown="",this._clearCountdownTimer();return}const s=i-Date.now()/1e3;if(s<=0){this._countdown="",this._clearCountdownTimer();return}const o=Math.floor(s/3600),a=Math.floor(s%3600/60);this._countdown=o>0?`${o}h ${a}m`:`${a}m`};t(),this._countdownTimer=setInterval(t,3e4)}_getEffectiveOverride(){var e;return(e=this.overrideInfo)!=null&&e.active?this.overrideInfo:null}_renderTargetSection(e){var o,a;const t=e.target_temp,i=((o=this.hass)==null?void 0:o.language)??"en",s=this._getEffectiveOverride();if(s){const r=s.type==="boost"?"mdi:fire":s.type==="eco"?"mdi:leaf":"mdi:thermometer",c=s.type==="boost"?n("override.comfort",i):s.type==="eco"?n("override.eco",i):n("override.custom",i),d=`override-${s.type}`,p=s.temp??t;return l`
        ...
        ${e?l`
              ...
              <div class="hero-temps">
                ${e.current_temp!==null?l`
                      ...
                      <span class="hero-unit">${v(this.hass)}</span>
              ...
              ${e.current_humidity!==null?l`<div class="hero-metric">
                    ...
                    ${n("hero.humidity",((m=this.hass)==null?void 0:m.language)??"en",{value:e.current_humidity.toFixed(0)})}
                  </div>`:h}
              ${e.trv_setpoint!=null?l`<div class="hero-metric">
                    <ha-icon icon="mdi:radiator"></ha-icon>
                    ${n("hero.trv_setpoint",((g=this.hass)==null?void 0:g.language)??"en",{value:E(e.trv_setpoint,this.hass),unit:v(this.hass)})}
                  </div>`:h}
              ...
              ${e.mold_prevention_active?l`<div class="hero-metric info">
                    <ha-icon icon="mdi:shield-check"></ha-icon>
                    ${n("card.mold_prevention",((S=this.hass)==null?void 0:S.language)??"en",{delta:W(e.mold_prevention_delta,this.hass).toFixed(0),unit:v(this.hass)})}
                  </div>`:h}
              ${this.climateControlActive?h:l`<div class="uncontrolled-hint">${n("card.not_controlled",((D=this.hass)==null?void 0:D.language)??"en")}</div>`}
            `:this.config?l`<div class="hero-no-data">${n("hero.waiting",((T=this.hass)==null?void 0:T.language)??"en")}</div>`:l`<div class="hero-no-data">${n("hero.not_configured",((y=this.hass)==null?void 0:y.language)??"en")}</div>`}
      </ha-card>
    `}};G.styles=[nt,j`
      :host {
        display: block;
    ...
    `],X([_({attribute:!1})],G.prototype,"hass",2),X([_({attribute:!1})],G.prototype,"area",2),X([_({attribute:!1})],G.prototype,"config",2),X([_({type:Boolean})],G.prototype,"climateControlActive",2),X([_({attribute:!1})],G.prototype,"overrideInfo",2),X([u()],G.prototype,"_countdown",2),X([u()],G.prototype,"_editingName",2),X([u()],G.prototype,"_nameInput",2),G=X([Q("rs-hero-status")],G);var Bt=Object.defineProperty,jt=Object.getOwnPropertyDescriptor,Ie=(e,t,i,s)=>{for(var o=s>1?void 0:s?jt(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Bt(t,i,o),o};let $e=class extends N{constructor(){super(...arguments),this.climateMode="auto",this.language="en"}render(){const e=this.language;return l`
      <div class="mode-grid">
    ...
    `}_onModeClick(e){this.dispatchEvent(new CustomEvent("mode-changed",{detail:{mode:e},bubbles:!0,composed:!0}))}};$e.styles=j`
    :host {
      display: block;
    }
  ...
  `,Ie([_({type:String})],$e.prototype,"climateMode",2),Ie([_({type:String})],$e.prototype,"language",2),$e=Ie([Q("rs-climate-mode-selector")],$e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ne extends Gt{constructor(t){if(super(t),this.it=h,t.type!==Kt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===h||t==null)return this._t=void 0,this.it=t;if(t===ce)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}Ne.directiveName="unsafeHTML",Ne.resultType=1;const ee=Zt(Ne);function te(e){const t=e.detail;return(t==null?void 0:t.value)??e.target.value??""}function K(e,t){e.dispatchEvent(new CustomEvent("save-status",{detail:{status:t},bubbles:!0,composed:!0}))}function Te(e,t){e.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}var qt=Object.defineProperty,Qt=Object.getOwnPropertyDescriptor,q=(e,t,i,s)=>{for(var o=s>1?void 0:s?Qt(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&qt(t,i,o),o};let F=class extends N{constructor(){super(...arguments),this.schedules=[],this.scheduleSelectorEntity="",this.activeScheduleIndex=0,this.comfortHeat=21,this.comfortCool=24,this.ecoHeat=17,this.ecoCool=27,this.climateMode="auto",this.editing=!1}render(){return this.editing?this._renderEditMode():this._renderViewMode()}_renderViewMode(){var i,s,o,a;const e=this.hass.language,t=this.schedules.length>=2;return l`
      ${this.schedules.length>0?l`
          <div class="schedule-list">
            ${this.schedules.map((r,c)=>{var g,b,S;const d=this._getScheduleState(c),p=(b=(g=this.hass)==null?void 0:g.states)==null?void 0:b[r.entity_id],m=((S=p==null?void 0:p.attributes)==null?void 0:S.friendly_name)||r.entity_id;return l`
                <div class="schedule-row ${d}">
                  ${t?l`<span class="schedule-number">${c+1}</span>`:h}
                  <span class="schedule-status-dot"></span>
                  <span class="schedule-name schedule-link" @click=${()=>Te(this,r.entity_id)}>${m}</span>
      ...
      ${this.climateMode==="auto"?l`
        <div class="view-temps">
          ${n("schedule.view_heat",e,{comfort:E(this.comfortHeat,this.hass),eco:E(this.ecoHeat,this.hass),unit:v(this.hass)})}
          \u00A0\u00B7\u00A0
          ${n("schedule.view_cool",e,{comfort:E(this.comfortCool,this.hass),eco:E(this.ecoCool,this.hass),unit:v(this.hass)})}
        </div>
      `:l`
        <div class="view-temps">
          ${n("schedule.view_comfort",e,{temp:E(this.climateMode==="cool_only"?this.comfortCool:this.comfortHeat,this.hass),unit:v(this.hass)})}
          \u00A0\u00B7\u00A0
          ${n("schedule.view_eco",e,{temp:E(this.climateMode==="cool_only"?this.ecoCool:this.ecoHeat,this.hass),unit:v(this.hass)})}
        </div>
      `}

      ${this.scheduleSelectorEntity?l`<div class="view-selector-info">
            ${n("schedule.view_selector_prefix",e)}
            <span class="schedule-link" @click=${()=>Te(this,this.scheduleSelectorEntity)}>${((a=(o=(s=(i=this.hass)==null?void 0:i.states)==null?void 0:s[this.scheduleSelectorEntity])==null?void 0:o.attributes)==null?void 0:a.friendly_name)||this.scheduleSelectorEntity}</span>
          </div>`:h}
      ...
      ${this.climateMode==="auto"?l`
        <div class="temp-grid-auto">
          ...
          <ha-textfield type="number"
            .value=${String(R(this.comfortHeat,this.hass))}
            suffix=${v(this.hass)} step=${Y(this.hass)}
            min=${z(5,35,this.hass).min} max=${z(5,35,this.hass).max}
            @change=${this._onComfortHeatChange}
          ></ha-textfield>
          <ha-textfield type="number"
            .value=${String(R(this.ecoHeat,this.hass))}
            suffix=${v(this.hass)} step=${Y(this.hass)}
            min=${z(5,35,this.hass).min} max=${z(5,35,this.hass).max}
          ...
          <ha-textfield type="number"
            .value=${String(R(this.comfortCool,this.hass))}
            suffix=${v(this.hass)} step=${Y(this.hass)}
            min=${z(5,35,this.hass).min} max=${z(5,35,this.hass).max}
            @change=${this._onComfortCoolChange}
          ></ha-textfield>
          <ha-textfield type="number"
            .value=${String(R(this.ecoCool,this.hass))}
            suffix=${v(this.hass)} step=${Y(this.hass)}
            min=${z(5,35,this.hass).min} max=${z(5,35,this.hass).max}
        ...
        <div class="temp-inputs">
          <div class="temp-input-group">
            <ha-textfield type="number"
              ...
              suffix=${v(this.hass)} step=${Y(this.hass)}
              .value=${String(R(this.climateMode==="cool_only"?this.comfortCool:this.comfortHeat,this.hass))}
              min=${z(5,35,this.hass).min} max=${z(5,35,this.hass).max}
          ...
          <div class="temp-input-group">
            <ha-textfield type="number"
              ...
              suffix=${v(this.hass)} step=${Y(this.hass)}
              .value=${String(R(this.climateMode==="cool_only"?this.ecoCool:this.ecoHeat,this.hass))}
              min=${z(5,35,this.hass).min} max=${z(5,35,this.hass).max}
      ...
      <ha-expansion-panel outlined header=${n("schedule.help_header",e)}>
        <div class="help-content">
          ...
          <ol style="margin: 4px 0 0 0; padding-left: 20px; font-size: 12px; line-height: 1.8">
            <li>${ee(n("schedule.help_temps_1",e))}</li>
            <li>${ee(n("schedule.help_temps_2",e))}</li>
            <li>${ee(n("schedule.help_temps_3",e))}</li>
            <li>${ee(n("schedule.help_temps_4",e))}</li>
          </ol>

          <p style="margin-top: 12px"><strong>${n("schedule.help_block_title",e)}</strong></p>
          <p>${ee(n("schedule.help_block",e))}</p>
  ...
  <span class="yaml-key">living_room_heating</span>:
    ...
    <span class="yaml-key">monday</span>:
      ...
      - <span class="yaml-key">from</span>: <span class="yaml-value">"17:00:00"</span>
        ...
        <span class="yaml-key">data</span>:
          ...
          <p style="margin-top: 8px">${ee(n("schedule.help_block_note",e))}</p>

          <p style="margin-top: 12px"><strong>${n("schedule.help_split_title",e)}</strong></p>
          <p>${ee(n("schedule.help_split",e))}</p>
        ...
        <span class="yaml-key">data</span>:
          ...
          <p style="margin-top: 8px">${ee(n("schedule.help_split_note",e))}</p>

          <p style="margin-top: 12px"><strong>${n("schedule.help_multi_title",e)}</strong></p>
          <p>${ee(n("schedule.help_multi",e))}</p>
        </div>
      </ha-expansion-panel>
    ...
    `}_getScheduleState(e){var i,s,o,a;if(this.schedules.length===0)return"inactive";if(e===this.activeScheduleIndex)return"active";if(!this.scheduleSelectorEntity)return e===0?"active":"unreachable";const t=(s=(i=this.hass)==null?void 0:i.states)==null?void 0:s[this.scheduleSelectorEntity];if(!t)return"inactive";if(this.scheduleSelectorEntity.startsWith("input_boolean."))return e<=1?"inactive":"unreachable";if(this.scheduleSelectorEntity.startsWith("input_number.")){const r=Number(((o=t.attributes)==null?void 0:o.min)??1),c=Number(((a=t.attributes)==null?void 0:a.max)??this.schedules.length),d=e+1;return d>=r&&d<=c?"inactive":"unreachable"}return"inactive"}_getStatusText(e,t){var r,c,d;const i=this.hass.language;if(t==="unreachable")return n("schedule.state_unreachable",i);if(t==="inactive")return n("schedule.state_inactive",i);const s=this.schedules[e],o=(c=(r=this.hass)==null?void 0:r.states)==null?void 0:c[s.entity_id];if(!o)return n("schedule.state_active",i);if(o.state==="on"){const p=(d=o.attributes)==null?void 0:d.temperature;return p!=null?n("schedule.from_schedule",i,{temp:String(p),unit:v(this.hass)}):n("schedule.fallback",i,{temp:E(this.climateMode==="cool_only"?this.comfortCool:this.comfortHeat,this.hass),unit:v(this.hass)})}return n("schedule.eco_detail",i,{temp:E(this.climateMode==="cool_only"?this.ecoCool:this.ecoHeat,this.hass),unit:v(this.hass)})}_getScheduleEntities(){var e;return(e=this.hass)!=null&&e.states?Object.keys(this.hass.states).filter(t=>t.startsWith("schedule.")):[]}_getAvailableScheduleEntities(){const e=this._getScheduleEntities(),t=new Set(this.schedules.map(i=>i.entity_id));return e.filter(i=>!t.has(i))}_onAddSchedule(e){const t=te(e);if(!t)return;const i=[...this.schedules,{entity_id:t}];this.dispatchEvent(new CustomEvent("schedules-changed",{detail:{value:i},bubbles:!0,composed:!0})),requestAnimationFrame(()=>{e.target.value=""})}_onRemoveSchedule(e){const t=this.schedules.filter((i,s)=>s!==e);this.dispatchEvent(new CustomEvent("schedules-changed",{detail:{value:t},bubbles:!0,composed:!0}))}_onMoveSchedule(e,t){const i=e+t;if(i<0||i>=this.schedules.length)return;const s=[...this.schedules],o=s[e];s[e]=s[i],s[i]=o,this.dispatchEvent(new CustomEvent("schedules-changed",{detail:{value:s},bubbles:!0,composed:!0}))}_onSelectorEntityChange(e){var i;const t=((i=e.detail)==null?void 0:i.value)??"";this.dispatchEvent(new CustomEvent("schedule-selector-changed",{detail:{value:t},bubbles:!0,composed:!0}))}_onComfortHeatChange(e){const t=e.target,i=ne(parseFloat(t.value)||R(21,this.hass),this.hass);this.dispatchEvent(new CustomEvent("comfort-heat-changed",{detail:{value:i},bubbles:!0,composed:!0})),this.comfortCool<i&&this.dispatchEvent(new CustomEvent("comfort-cool-changed",{detail:{value:i},bubbles:!0,composed:!0}))}_onComfortCoolChange(e){const t=e.target,i=ne(parseFloat(t.value)||R(24,this.hass),this.hass);this.dispatchEvent(new CustomEvent("comfort-cool-changed",{detail:{value:i},bubbles:!0,composed:!0})),this.comfortHeat>i&&this.dispatchEvent(new CustomEvent("comfort-heat-changed",{detail:{value:i},bubbles:!0,composed:!0}))}_onEcoHeatChange(e){const t=e.target,i=ne(parseFloat(t.value)||R(17,this.hass),this.hass);this.dispatchEvent(new CustomEvent("eco-heat-changed",{detail:{value:i},bubbles:!0,composed:!0})),this.ecoCool<i&&this.dispatchEvent(new CustomEvent("eco-cool-changed",{detail:{value:i},bubbles:!0,composed:!0}))}_onEcoCoolChange(e){const t=e.target,i=ne(parseFloat(t.value)||R(27,this.hass),this.hass);this.dispatchEvent(new CustomEvent("eco-cool-changed",{detail:{value:i},bubbles:!0,composed:!0})),this.ecoHeat>i&&this.dispatchEvent(new CustomEvent("eco-heat-changed",{detail:{value:i},bubbles:!0,composed:!0}))}};F.styles=j`
    :host {
      display: block;
    }
  ...
  `,q([_({attribute:!1})],F.prototype,"hass",2),q([_({attribute:!1})],F.prototype,"schedules",2),q([_({type:String})],F.prototype,"scheduleSelectorEntity",2),q([_({type:Number})],F.prototype,"activeScheduleIndex",2),q([_({type:Number})],F.prototype,"comfortHeat",2),q([_({type:Number})],F.prototype,"comfortCool",2),q([_({type:Number})],F.prototype,"ecoHeat",2),q([_({type:Number})],F.prototype,"ecoCool",2),q([_({type:String})],F.prototype,"climateMode",2),q([_({type:Boolean})],F.prototype,"editing",2),F=q([Q("rs-schedule-settings")],F);var Yt=Object.defineProperty,Jt=Object.getOwnPropertyDescriptor,V=(e,t,i,s)=>{for(var o=s>1?void 0:s?Jt(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Yt(t,i,o),o};let I=class extends N{constructor(){super(...arguments),this.selectedThermostats=new Set,this.selectedAcs=new Set,this.selectedTempSensor="",this.selectedHumiditySensor="",this.selectedWindowSensors=new Set,this.windowOpenDelay=0,this.windowCloseDelay=0,this.heatingSystemType="",this.editing=!1,this._systemTypeInfoExpanded=!1,this._entityFilter=e=>{var i,s,o,a;const t=e.entity_id;if(this.selectedThermostats.has(t)||this.selectedAcs.has(t)||this.selectedTempSensor===t||this.selectedHumiditySensor===t||this.selectedWindowSensors.has(t))return!1;if(t.startsWith("sensor.")){const r=(s=(i=this.hass.states[t])==null?void 0:i.attributes)==null?void 0:s.device_class;if(r!=="temperature"&&r!=="humidity")return!1}if(t.startsWith("binary_sensor.")){const r=(a=(o=this.hass.states[t])==null?void 0:o.attributes)==null?void 0:a.device_class;if(r!=="window"&&r!=="door")return!1}return!0}}render(){return this.editing?this._renderEditMode():this._renderViewMode()}_renderViewMode(){const e=this.selectedThermostats.size>0||this.selectedAcs.size>0,t=!!this.selectedTempSensor,i=!!this.selectedHumiditySensor;return l`
      ...
      `:h}
    `}_renderViewRow(e,t){var c;const i=this.hass.states[e],s=((c=i==null?void 0:i.attributes)==null?void 0:c.friendly_name)||e,o=i==null?void 0:i.state,a=(i==null?void 0:i.attributes)??{};let r="";if(t==="climate"){const d=a.current_temperature;d!=null&&(r=`${d.toFixed(1)}°`)}else t==="temp"?o&&o!=="unknown"&&o!=="unavailable"&&(r=`${Number(o).toFixed(1)}${v(this.hass)}`):o&&o!=="unknown"&&o!=="unavailable"&&(r=`${Math.round(Number(o))}%`);return l`
      <div class="view-row">
        <span class="view-name entity-link" @click=${()=>Te(this,e)}>${s}</span>
    ...
    `}_renderWindowViewRow(e){var o;const t=this.hass.states[e],i=((o=t==null?void 0:t.attributes)==null?void 0:o.friendly_name)||e,s=(t==null?void 0:t.state)==="on";return l`
      <div class="view-row">
        <span class="view-name entity-link" @click=${()=>Te(this,e)}>${i}</span>
        <span class="view-value" style="color: ${s?"var(--warning-color, #ff9800)":"var(--secondary-text-color)"}">
          ${s?"●":"○"}
        </span>
      </div>
    `}_renderEditMode(){var D,T,y,M,L;const e=it(this.area.area_id,(D=this.hass)==null?void 0:D.entities,(T=this.hass)==null?void 0:T.devices),t=e.filter(f=>f.entity_id.startsWith("climate.")),i=(y=this.hass)!=null&&y.states?e.filter(f=>{var H,B;return f.entity_id.startsWith("sensor.")&&((B=(H=this.hass.states[f.entity_id])==null?void 0:H.attributes)==null?void 0:B.device_class)==="temperature"}):[],s=(M=this.hass)!=null&&M.states?e.filter(f=>{var H,B;return f.entity_id.startsWith("sensor.")&&((B=(H=this.hass.states[f.entity_id])==null?void 0:H.attributes)==null?void 0:B.device_class)==="humidity"}):[],o=(L=this.hass)!=null&&L.states?e.filter(f=>{var H,B;return f.entity_id.startsWith("binary_sensor.")&&["window","door"].includes((B=(H=this.hass.states[f.entity_id])==null?void 0:H.attributes)==null?void 0:B.device_class)}):[],a=new Set(t.map(f=>f.entity_id)),c=[...new Set([...this.selectedThermostats,...this.selectedAcs])].filter(f=>!a.has(f)),d=new Set(i.map(f=>f.entity_id)),p=this.selectedTempSensor&&!d.has(this.selectedTempSensor)?this.selectedTempSensor:null,m=new Set(s.map(f=>f.entity_id)),g=this.selectedHumiditySensor&&!m.has(this.selectedHumiditySensor)?this.selectedHumiditySensor:null,b=new Set(o.map(f=>f.entity_id)),S=[...this.selectedWindowSensors].filter(f=>!b.has(f));return l`
      <div class="device-group">
        <div class="section-subtitle">${n("devices.climate_entities",this.hass.language)}</div>
        <div class="device-list-scroll">
          ${t.length>0?t.map(f=>this._renderClimateRow(f.entity_id,!1)):l`<div class="no-devices">
                ${n("devices.no_climate",this.hass.language)}
              </div>`}
          ${c.map(f=>this._renderClimateRow(f,!0))}
        </div>
      </div>
      ...
      <div class="device-group">
        <div class="section-subtitle">${n("devices.temp_sensors",this.hass.language)}</div>
        <div class="device-list-scroll">
          ${i.length>0?i.map(f=>this._renderSensorRow(f.entity_id,"temp",!1)):l`<div class="no-devices">
      ...
      <div class="device-group">
        <div class="section-subtitle">${n("devices.humidity_sensors",this.hass.language)}</div>
        <div class="device-list-scroll">
          ${s.length>0?s.map(f=>this._renderSensorRow(f.entity_id,"humidity",!1)):l`<div class="no-devices">
      ...
      <div class="device-group">
        <div class="section-subtitle">${n("devices.window_sensors",this.hass.language)}</div>
        <div class="device-list-scroll">
          ${o.length>0?o.map(f=>this._renderWindowRow(f.entity_id,!1)):l`<div class="no-devices">
                ${n("devices.no_window_sensors",this.hass.language)}
            </div>`}
          ${S.map(f=>this._renderWindowRow(f,!0))}
        </div>
        ${this.selectedWindowSensors.size>0?l`
    ...
    `}_renderClimateRow(e,t){var p,m;const i=this.selectedThermostats.has(e),s=this.selectedAcs.has(e),o=i||s,a=this.hass.states[e],r=((p=a==null?void 0:a.attributes)==null?void 0:p.friendly_name)||e,c=a==null?void 0:a.state,d=(m=a==null?void 0:a.attributes)==null?void 0:m.current_temperature;return l`
      <div class="device-row ${o?"selected":""}">
        <ha-checkbox
          .checked=${o}
          @change=${g=>{const b=g.target;this._onClimateToggle(e,b.checked)}}
        ></ha-checkbox>
        ...
        ${o?l`
              <ha-select
                ...
                @selected=${g=>{this._onDeviceTypeChange(e,te(g))}}
    ...
    `}_renderSensorRow(e,t,i){var m;const s=this.hass.states[e],o=((m=s==null?void 0:s.attributes)==null?void 0:m.friendly_name)||e,a=s==null?void 0:s.state,c=(t==="temp"?this.selectedTempSensor:this.selectedHumiditySensor)===e,d=t==="temp"?v(this.hass):"%",p=a&&a!=="unknown"&&a!=="unavailable";return l`
  ...
  `,V([_({attribute:!1})],I.prototype,"hass",2),V([_({attribute:!1})],I.prototype,"area",2),V([_({attribute:!1})],I.prototype,"selectedThermostats",2),V([_({attribute:!1})],I.prototype,"selectedAcs",2),V([_({type:String})],I.prototype,"selectedTempSensor",2),V([_({type:String})],I.prototype,"selectedHumiditySensor",2),V([_({attribute:!1})],I.prototype,"selectedWindowSensors",2),V([_({type:Number})],I.prototype,"windowOpenDelay",2),V([_({type:Number})],I.prototype,"windowCloseDelay",2),V([_({type:String})],I.prototype,"heatingSystemType",2),V([_({type:Boolean})],I.prototype,"editing",2),V([u()],I.prototype,"_systemTypeInfoExpanded",2),I=V([Q("rs-device-section")],I);const rt=j`
  .info-icon {
    --mdc-icon-size: 16px;
    color: var(--secondary-text-color);
    opacity: 0.3;
...
`;var Xt=Object.defineProperty,ei=Object.getOwnPropertyDescriptor,ae=(e,t,i,s)=>{for(var o=s>1?void 0:s?ei(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&Xt(t,i,o),o};const ti="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z",ii="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z";let J=class extends N{constructor(){super(...arguments),this.icon="",this.heading="",this.editable=!1,this.editing=!1,this.doneLabel="",this.hasInfo=!1,this._infoExpanded=!1}render(){return l`
      <ha-card>
    ...
    `}_toggleInfo(){this._infoExpanded=!this._infoExpanded}_onEditClick(){this.dispatchEvent(new CustomEvent("edit-click",{bubbles:!0,composed:!0}))}_onDoneClick(){this.dispatchEvent(new CustomEvent("done-click",{bubbles:!0,composed:!0}))}};J.styles=[rt,j`
      :host {
        display: block;
      }
        ...
        ${this._editingPresence?l`
          <div style="padding: 0 16px 16px">
            <div class="presence-chips">
              ${this.presencePersons.map(e=>{var s,o;const t=this._selectedPresencePersons.includes(e),i=((o=(s=this.hass.states[e])==null?void 0:s.attributes)==null?void 0:o.friendly_name)??e.split(".").slice(1).join(".");return l`
                  <button
              ...
              <div class="presence-list">
                ${this._selectedPresencePersons.map(e=>{var o,a,r;const t=((a=(o=this.hass.states[e])==null?void 0:o.attributes)==null?void 0:a.friendly_name)??e.split(".").slice(1).join("."),i=(r=this.hass.states[e])==null?void 0:r.state,s=e.startsWith("person.")||e.startsWith("device_tracker.")?i==="home":i==="on";return l`
                    <div class="presence-row ${s?"home":"away"}">
                      ...
                      <span class="presence-state">${s?n("presence.state_home",this.hass.language):n("presence.state_away",this.hass.language)}</span>
                    </div>
                  `})}
              </div>
            `:l`
      ...
      <div class="override-presets">
        ${["boost","eco","custom"].map(s=>{const o=t===s,a=t!==null&&!o,r=!t&&this._overridePending===s;return l`
            ...
            >
              ...
              ${s==="boost"?`${n("override.comfort",this.hass.language)} ${E(this._climateMode==="cool_only"?this._comfortCool:this._comfortHeat,this.hass)}${v(this.hass)}`:s==="eco"?`${n("override.eco",this.hass.language)} ${E(this._climateMode==="cool_only"?this._ecoCool:this._ecoHeat,this.hass)}${v(this.hass)}`:n("override.custom",this.hass.language)}
            </button>
          `})}
      </div>
      ${i?l`
            ${this._overridePending==="custom"?l`
                  <div class="override-custom-row">
                    ...
                    <input
                      type="number"
                      min=${z(5,35,this.hass).min}
                      max=${z(5,35,this.hass).max}
                      step=${Y(this.hass)}
                      .value=${String(R(this._overrideCustomTemp,this.hass))}
                      @input=${this._onOverrideCustomTempInput}
                    />
                    <span>${v(this.hass)}</span>
                  </div>
                `:h}
          ...
          `:h}
    `}_onOverridePreset(e){this._overridePending===e?this._overridePending=null:(this._overridePending=e,e==="custom"&&(this._overrideCustomTemp=this._climateMode==="cool_only"?this._comfortCool:this._comfortHeat)),this._overrideError=""}_onOverrideCustomTempInput(e){this._overrideCustomTemp=ne(Number(e.target.value)||R(21,this.hass),this.hass)}async _onOverrideActivate(e){if(!this._overridePending||!this.config)return;const t=this._overridePending;let i;t==="boost"?i=this._climateMode==="cool_only"?this._comfortCool:this._comfortHeat:t==="eco"?i=this._climateMode==="cool_only"?this._ecoCool:this._ecoHeat:i=this._overrideCustomTemp,this._optimisticOverride={type:t,temp:i,until:Date.now()/1e3+e*3600},this._optimisticClear=!1,this._overridePending=null,this._overrideError="";const s={type:"roommind/override/set",area_id:this.config.area_id,override_type:t,duration:e};t==="custom"&&(s.temperature=i);try{await this.hass.callWS(s),this._fireRoomUpdated()}catch(o){this._optimisticOverride=null,this._overrideError=o instanceof Error?o.message:n("override.error_set",this.hass.language),console.error("Override set failed:",o)}}async _onClearOverride(){if(this.config){this._optimisticClear=!0,this._optimisticOverride=null,this._overrideError="";try{await this.hass.callWS({type:"roommind/override/clear",area_id:this.config.area_id}),this._fireRoomUpdated()}catch(e){this._optimisticClear=!1,this._overrideError=e instanceof Error?e.message:n("override.error_clear",this.hass.language),console.error("Override clear failed:",e)}}}_fireRoomUpdated(){this.dispatchEvent(new CustomEvent("room-updated",{bubbles:!0,composed:!0}))}};x.styles=j`
    :host {
      display: block;
      max-width: 1100px;
      margin: 0 auto;
          ...
          <div class="settings-section">
            ...
            ${this._vacationActive?l`
                  <div class="threshold-grid" style="margin-top: 12px">
                    ...
                    <div class="threshold-field">
                      <ha-textfield
                        .value=${String(R(this._vacationTemp,this.hass))}
                        .label=${n("vacation.setback_temp",e)}
                        .suffix=${v(this.hass)}
                        type="number"
                        step=${Y(this.hass)}
                        min=${z(5,25,this.hass).min}
                        max=${z(5,25,this.hass).max}
                  ...
                  <div class="room-toggles" style="gap: 8px">
                    ...
                    ${this._presencePersons.length>0?l`
                      <div class="presence-person-list">
                        ${this._presencePersons.map(c=>{var p,m;const d=((m=(p=this.hass.states[c])==null?void 0:p.attributes)==null?void 0:m.friendly_name)??c.split(".").slice(1).join(".");return l`
        ...
        <div class="card-content">
          ...
          <div class="settings-section">
            ...
            <div class="threshold-grid">
              <div class="threshold-field">
                <ha-textfield
                  .value=${String(R(this._outdoorCoolingMin,this.hass))}
                  .label=${n("settings.outdoor_cooling_min",e)}
                  .suffix=${v(this.hass)}
                  type="number"
                  step=${Y(this.hass)}
                  min=${z(-10,40,this.hass).min}
                  max=${z(-10,40,this.hass).max}
              ...
              <div class="threshold-field">
                <ha-textfield
                  .value=${String(R(this._outdoorHeatingMax,this.hass))}
                  .label=${n("settings.outdoor_heating_max",e)}
                  .suffix=${v(this.hass)}
                  type="number"
                  step=${Y(this.hass)}
                  min=${z(0,40,this.hass).min}
                  max=${z(0,40,this.hass).max}
            ...
            <div class="sensor-grid">
              <div class="sensor-field">
                ...
                ${t!==null?l`<div class="current-value">
                      ${n("settings.outdoor_current",e,{temp:t.toFixed(1),unit:v(this.hass)})}
        ...
        <div class="card-content">
            ...
            ${this._moldPreventionEnabled?l`
                  <div style="margin-top: 12px; display: flex; flex-direction: column; gap: 4px;">
                    <ha-select
                      ...
                      .options=${[{value:"light",label:n("mold.intensity_light",e,{delta:String(W(1,this.hass)),unit:v(this.hass)})},{value:"medium",label:n("mold.intensity_medium",e,{delta:String(W(2,this.hass)),unit:v(this.hass)})},{value:"strong",label:n("mold.intensity_strong",e,{delta:String(W(3,this.hass)),unit:v(this.hass)})}]}
                      @selected=${this._onMoldIntensityChanged}
                      @closed=${c=>c.stopPropagation()}
                    >
                      <ha-list-item value="light">${n("mold.intensity_light",e,{delta:String(W(1,this.hass)),unit:v(this.hass)})}</ha-list-item>
                      <ha-list-item value="medium">${n("mold.intensity_medium",e,{delta:String(W(2,this.hass)),unit:v(this.hass)})}</ha-list-item>
                      <ha-list-item value="strong">${n("mold.intensity_strong",e,{delta:String(W(3,this.hass)),unit:v(this.hass)})}</ha-list-item>
                    </ha-select>
          ...
          ${this._moldDetectionEnabled||this._moldPreventionEnabled?l`
                <div class="settings-section">
                  ...
                  <!-- Target list -->
                  <div class="presence-person-list">
                    ${this._moldNotificationTargets.map((c,d)=>{var m,g;const p=c.entity_id?((g=(m=this.hass.states[c.entity_id])==null?void 0:m.attributes)==null?void 0:g.friendly_name)??c.entity_id.replace("notify.",""):n("mold.target_unnamed",e);return l`
  ...
  `,$([_({attribute:!1})],w.prototype,"hass",2),$([_({attribute:!1})],w.prototype,"rooms",2),$([u()],w.prototype,"_groupByFloor",2),$([u()],w.prototype,"_climateControlActive",2),$([u()],w.prototype,"_learningDisabledRooms",2),$([u()],w.prototype,"_showLearningExceptions",2),$([u()],w.prototype,"_outdoorTempSensor",2),$([u()],w.prototype,"_outdoorHumiditySensor",2),$([u()],w.prototype,"_outdoorCoolingMin",2),$([u()],w.prototype,"_outdoorHeatingMax",2),$([u()],w.prototype,"_controlMode",2),$([u()],w.prototype,"_comfortWeight",2),$([u()],w.prototype,"_weatherEntity",2),$([u()],w.prototype,"_predictionEnabled",2),$([u()],w.prototype,"_vacationActive",2),$([u()],w.prototype,"_vacationTemp",2),$([u()],w.prototype,"_vacationUntil",2),$([u()],w.prototype,"_presenceEnabled",2),$([u()],w.prototype,"_presencePersons",2),$([u()],w.prototype,"_presenceAwayAction",2),$([u()],w.prototype,"_scheduleOffAction",2),$([u()],w.prototype,"_valveProtectionEnabled",2),$([u()],w.prototype,"_valveProtectionInterval",2),$([u()],w.prototype,"_moldDetectionEnabled",2),$([u()],w.prototype,"_moldHumidityThreshold",2),$([u()],w.prototype,"_moldSustainedMinutes",2),$([u()],w.prototype,"_moldNotificationCooldown",2),$([u()],w.prototype,"_moldNotificationsEnabled",2),$([u()],w.prototype,"_moldNotificationTargets",2),$([u()],w.prototype,"_moldPreventionEnabled",2),$([u()],w.prototype,"_moldPreventionIntensity",2),$([u()],w.prototype,"_moldPreventionNotify",2),$([u()],w.prototype,"_resetSelectedRoom",2),$([u()],w.prototype,"_loaded",2),w=$([Q("rs-settings")],w);var li=Object.defineProperty,ci=Object.getOwnPropertyDescriptor,O=(e,t,i,s)=>{for(var o=s>1?void 0:s?ci(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&li(t,i,o),o};const di=3*36e5;let P=class extends N{constructor(){super(...arguments),this.rooms={},this.initialRoom="",this.controlMode="bangbang",this._selectedRoom="",this._rangeStart=new Date(new Date().setHours(0,0,0,0)).getTime(),this._rangeEnd=Date.now(),this._data=null,this._chartAnchor=Date.now(),this._loading=!1,this._hiddenSeries=new Set(["outdoor_temp"]),this._expandedStat=null,this._chartInfoExpanded=!1,this._openDropdown=null,this._activeQuick="24h",this._boundCloseDropdowns=this._closeDropdowns.bind(this)}connectedCallback(){super.connectedCallback(),this._refreshInterval=setInterval(()=>this._silentRefresh(),6e4),document.addEventListener("click",this._boundCloseDropdowns)}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&(clearInterval(this._refreshInterval),this._refreshInterval=void 0),document.removeEventListener("click",this._boundCloseDropdowns)}willUpdate(e){e.has("initialRoom")&&this.initialRoom&&(this._selectedRoom=this.initialRoom);let t=!1;if(e.has("rooms")&&!this._selectedRoom){const i=Object.keys(this.rooms);i.length>0&&(this._selectedRoom=i[0],t=!0,this.dispatchEvent(new CustomEvent("room-selected",{detail:{areaId:i[0]},bubbles:!0,composed:!0})))}(t||e.has("_selectedRoom")||e.has("_rangeStart")||e.has("_rangeEnd"))&&this._selectedRoom&&this._fetchData()}updated(e){(e.has("rooms")||e.has("_selectedRoom"))&&this._selectedRoom&&this.updateComplete.then(()=>{var i;const t=(i=this.renderRoot)==null?void 0:i.querySelector("ha-select");t&&t.value!==this._selectedRoom&&(t.value=this._selectedRoom)})}render(){const e=this.hass.language,t=this._getConfiguredRooms();return l`
    ...
    `}_renderChart(e){var c;const t=this._data?[...this._data.history,...this._data.detail]:[],i=[...t,...((c=this._data)==null?void 0:c.forecast)??[]],s=t.length>0?this._buildChartSeries(t,e):[],o=[],a=s.map(d=>{const p=d.id,m=d.lineStyle||{},g=p.endsWith("_events");if(this._hiddenSeries.has(p)){const S={...d,lineStyle:{...m,width:0,opacity:0}};return d.areaStyle&&(S.areaStyle={...d.areaStyle,opacity:0}),S}if(!g&&p!=="now_marker")for(const S of d.data)S&&S[1]!=null&&o.push(S[1]);const b={...d,lineStyle:{...m,opacity:1}};return d.areaStyle&&(b.areaStyle={...d.areaStyle,opacity:1}),b}),r=this._buildChartOptions(o,e,i);return l`
      <ha-card>
        <div class="card-header">
    ...
    `}_buildChartSeries(e,t){var T;const i=[],s=[],o=[],a=[],r=y=>R(y,this.hass);for(const y of e){const M=y.ts*1e3;y.room_temp!==null&&i.push([M,r(y.room_temp)]),y.target_temp!==null&&s.push([M,r(y.target_temp)]),y.predicted_temp!==null&&o.push([M,r(y.predicted_temp)]),y.outdoor_temp!==null&&a.push([M,r(y.outdoor_temp)])}for(const y of((T=this._data)==null?void 0:T.forecast)??[]){const M=y.ts*1e3;y.target_temp!==null&&s.push([M,r(y.target_temp)]),y.predicted_temp!==null&&o.push([M,r(y.predicted_temp)])}const c=[{id:"room_temp",type:"line",name:n("analytics.temperature",t),color:"rgb(255, 152, 0)",data:i,showSymbol:!1,smooth:!0,lineStyle:{width:2},yAxisIndex:0},{id:"target_temp",type:"line",name:n("analytics.target",t),color:"rgb(76, 175, 80)",data:s,showSymbol:!1,smooth:!1,lineStyle:{width:2,type:"dashed"},yAxisIndex:0}];o.length>0&&c.push({id:"predicted_temp",type:"line",name:n("analytics.prediction",t),color:"rgb(33, 150, 243)",data:o,showSymbol:!1,smooth:!0,lineStyle:{width:2,type:"dotted"},yAxisIndex:0}),a.length>0&&c.push({id:"outdoor_temp",type:"line",name:n("analytics.outdoor",t),color:"rgb(158, 158, 158)",data:a,showSymbol:!1,smooth:!0,lineStyle:{width:1},yAxisIndex:0});const d=[],p=[],m=[];let g=!1,b=!1,S=!1;for(const y of e){const M=y.ts*1e3;y.mode==="heating"?(d.push([M,999]),g=!0):d.push([M,null]),y.mode==="cooling"?(p.push([M,999]),b=!0):p.push([M,null]),y.window_open?(m.push([M,999]),S=!0):m.push([M,null])}g&&c.push({id:"heating_events",type:"line",name:n("analytics.heating_period",t),color:"rgb(244, 67, 54)",data:d,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:"rgba(244, 67, 54, 0.08)",origin:"start"},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),b&&c.push({id:"cooling_events",type:"line",name:n("analytics.cooling_period",t),color:"rgb(63, 81, 181)",data:p,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:"rgba(63, 81, 181, 0.08)",origin:"start"},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),S&&c.push({id:"window_events",type:"line",name:n("analytics.window_open_period",t),color:"rgb(0, 150, 136)",data:m,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:"rgba(0, 150, 136, 0.1)",origin:"start"},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1});const D=this._chartAnchor;return c.push({id:"now_marker",type:"line",name:"",color:"rgba(255,255,255,0.3)",data:[[D,-999],[D,999]],showSymbol:!1,lineStyle:{width:1,type:"dashed"},yAxisIndex:0,tooltip:{show:!1},z:-2}),c}_buildChartOptions(e,t,i=[]){const s={type:"value",name:v(this.hass)};if(e.length>0){let c=1/0,d=-1/0;for(const g of e)g<c&&(c=g),g>d&&(d=g);const p=d-c,m=Math.max(p*.1,.5);s.min=Math.floor((c-m)*2)/2,s.max=Math.ceil((d+m)*2)/2}const o=this._chartAnchor,a=this._rangeStart,r=Math.abs(this._rangeEnd-Date.now())<36e5;return{xAxis:{type:"time",min:a,max:r?o+di:this._rangeEnd},yAxis:s,dataZoom:[{type:"inside",xAxisIndex:0,filterMode:"none"}],tooltip:{trigger:"axis",axisPointer:{snap:!1},valueFormatter:c=>c.toFixed(1)+" "+v(this.hass),formatter:c=>{var S,D;if(!Array.isArray(c)||c.length===0)return"";let m=`<div style="font-weight:500;margin-bottom:4px">${new Date(c[0].value[0]).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}</div>`,g=null,b=null;for(const T of c){if((S=T.seriesId)!=null&&S.endsWith("_events"))continue;const y=(D=T.value)==null?void 0:D[1];y!=null&&(m+=`<div>${T.color?`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${T.color};margin-right:6px"></span>`:""}${T.seriesName}: ${y.toFixed(1)} ${v(this.hass)}</div>`,T.seriesId==="room_temp"&&(g=y),T.seriesId==="predicted_temp"&&(b=y))}if(g!==null&&b!==null){const T=g-b,y=T>=0?"+":"";m+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px">Delta: ${y}${T.toFixed(2)} ${v(this.hass)}</div>`}if(i.length>0){const T=c[0].value[0]/1e3;let y=null,M=1/0;for(const L of i){const f=Math.abs(L.ts-T);f<M&&(M=f,y=L)}if(y){const L=[];if(y.mode==="heating"){const f=y.heating_power;if(f!=null&&f>0&&f<100?L.push(`${n("analytics.heating_period",t)} ${f}%`):L.push(n("analytics.heating_period",t)),f!=null&&f>0&&y.room_temp!=null){const H=Math.round((y.room_temp+f/100*(30-y.room_temp))*10)/10;L.push(`TRV ${E(H,this.hass)} ${v(this.hass)}`)}}else y.mode==="cooling"&&L.push(n("analytics.cooling_period",t));y.window_open&&L.push(n("analytics.window_open_period",t)),L.length>0&&(m+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px;color:rgba(255,255,255,0.7)">${L.join(" · ")}</div>`)}}return m}},grid:{top:15,left:10,right:10,bottom:5,containLabel:!0}}}_renderModelStatus(e){var ct,dt,ht;const t=!!((dt=(ct=this._data)==null?void 0:ct.model)!=null&&dt.model),i=(ht=this._data)==null?void 0:ht.model,s=i==null?void 0:i.model,o=(i==null?void 0:i.confidence)??0,a=(i==null?void 0:i.n_samples)??0,r=(i==null?void 0:i.n_heating)??0,c=(i==null?void 0:i.n_cooling)??0,d=(i==null?void 0:i.applicable_modes)??[],p=i==null?void 0:i.prediction_std_idle,m=i==null?void 0:i.prediction_std_heating,g=(i==null?void 0:i.mpc_active)??!1,b=Math.round(o*100),S=new Set(d),D=S.has("heating"),T=S.has("cooling"),y=r>=10,M=c>=10,L=a-r-c>=10,f=(i==null?void 0:i.n_observations)??a,H="—",B=[],me=(ie,pt,ut,bi,vi)=>{B.push({id:ie,labelKey:ut,infoKey:vi});const mt=this._expandedStat===ie;return l`
        <div class="model-stat ${mt?"active":""}" @click=${()=>this._toggleStat(ie)}>
          <div class="stat-content">
            <span class="model-value ${pt===H?"pending":""}">${pt}</span>
      ...
      <ha-card>
        ...
        <div class="card-content">
          ...
          <div class="confidence-hero">
            <div class="confidence-top">
              ...
              <div class="confidence-meta">
                <span class="meta-value">${t?f:0}</span>
          ...
          <div class="model-grid">
            ${me("time_constant",L&&s&&s.U>0?(1/s.U).toFixed(1)+"h":H,"analytics.time_constant","","analytics.info.time_constant")}
            ${D?me("heating_rate",y&&s?W(s.Q_heat,this.hass).toFixed(1)+v(this.hass)+"/h":H,"analytics.heating_rate","","analytics.info.heating_rate"):h}
            ${T?me("cooling_rate",M&&s?W(s.Q_cool,this.hass).toFixed(1)+v(this.hass)+"/h":H,"analytics.cooling_rate","","analytics.info.cooling_rate"):h}
            ${s&&s.Q_solar>.1?me("solar_gain",W(s.Q_solar,this.hass).toFixed(1)+v(this.hass)+"/h","analytics.solar_gain","","analytics.info.solar_gain"):h}
            ${me("accuracy_idle",L&&p!=null?"±"+W(p,this.hass).toFixed(2)+v(this.hass):H,"analytics.accuracy_idle","","analytics.info.accuracy_idle")}
            ${D?me("accuracy_heating",y&&m!=null?"±"+W(m,this.hass).toFixed(2)+v(this.hass):H,"analytics.accuracy_heating","","analytics.info.accuracy_heating"):h}
          </div>
          ${this._expandedStat&&B.find(ie=>ie.id===this._expandedStat)?l`<div class="info-panel stat-info-panel">
                <strong>${n(B.find(ie=>ie.id===this._expandedStat).labelKey,e)}</strong>
                ${n(B.find(ie=>ie.id===this._expandedStat).infoKey,e)}
              </div>`:h}
...
`)}_buildDiagnosticsString(){var o,a,r,c;if(!this._selectedRoom||!this._data)return null;const e=(o=this.rooms)==null?void 0:o[this._selectedRoom],t=[...this._data.history??[],...this._data.detail??[]],i=t.length>0?t[t.length-1]:null,s={version:"0.2.0",area_id:this._selectedRoom,room_config:{climate_mode:e==null?void 0:e.climate_mode,has_thermostats:(((a=e==null?void 0:e.thermostats)==null?void 0:a.length)||0)>0,has_acs:(((r=e==null?void 0:e.acs)==null?void 0:r.length)||0)>0,has_temp_sensor:!!(e!=null&&e.temperature_sensor),has_window_sensors:(((c=e==null?void 0:e.window_sensors)==null?void 0:c.length)||0)>0},live:(e==null?void 0:e.live)||{},model:this._data.model||{},settings:{control_mode:this.controlMode},outdoor:{temp:(i==null?void 0:i.outdoor_temp)??null}};return JSON.stringify(s,null,2)}_downloadString(e,t,i){const s=new Blob([e],{type:`${i};charset=utf-8`}),o=URL.createObjectURL(s),a=document.createElement("a");a.href=o,a.download=t,a.click(),URL.revokeObjectURL(o)}_exportCsv(){var r,c;const e=this._buildCsvString();if(!e)return;const t=(c=(r=this.hass)==null?void 0:r.areas)==null?void 0:c[this._selectedRoom],i=this.rooms[this._selectedRoom],s=((i==null?void 0:i.display_name)||(t==null?void 0:t.name)||this._selectedRoom).replace(/\s+/g,"_").toLowerCase(),o=new Date(this._rangeStart).toISOString().slice(0,10),a=new Date(this._rangeEnd).toISOString().slice(0,10);this._downloadString(e,`roommind_${s}_${o}_${a}.csv`,"text/csv"),this._openDropdown=null}_exportDiagnostics(){var o,a;const e=this._buildDiagnosticsString();if(!e)return;const t=(a=(o=this.hass)==null?void 0:o.areas)==null?void 0:a[this._selectedRoom],i=this.rooms[this._selectedRoom],s=((i==null?void 0:i.display_name)||(t==null?void 0:t.name)||this._selectedRoom).replace(/\s+/g,"_").toLowerCase();this._downloadString(e,`roommind_diagnostics_${s}.json`,"application/json"),this._openDropdown=null}_copyToClipboard(e){var t;return(t=navigator.clipboard)!=null&&t.writeText?(navigator.clipboard.writeText(e).catch(()=>{this._copyToClipboardFallback(e)}),!0):this._copyToClipboardFallback(e)}_copyToClipboardFallback(e){const t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();let i=!1;try{i=document.execCommand("copy")}catch(s){console.debug("[RoomMind] clipboard fallback:",s)}return document.body.removeChild(t),i}_copyCsvToClipboard(){const e=this._buildCsvString();e&&(this._copyToClipboard(e),this._openDropdown=null)}_copyDiagnosticsToClipboard(){const e=this._buildDiagnosticsString();e&&(this._copyToClipboard(e),this._openDropdown=null)}_toggleDropdown(e){this._openDropdown=this._openDropdown===e?null:e}_closeDropdowns(){this._openDropdown&&(this._openDropdown=null)}_buildWsParams(){return{type:"roommind/analytics/get",area_id:this._selectedRoom,start_ts:this._rangeStart/1e3,end_ts:this._rangeEnd/1e3}}async _fetchData(){if(this._selectedRoom){this._loading=!0,this._data=null,this._chartAnchor=this._rangeEnd;try{const e=await this.hass.callWS(this._buildWsParams());this._data=e}catch(e){console.debug("[RoomMind] fetchData:",e),this._data=null}finally{this._loading=!1}}}async _silentRefresh(){if(!(!this._selectedRoom||this._loading))try{const e=await this.hass.callWS(this._buildWsParams());this._data=e,this._chartAnchor=Date.now()}catch(e){console.debug("[RoomMind] silentRefresh:",e)}}};P.styles=[rt,j`
  ...
  `],O([_({attribute:!1})],P.prototype,"hass",2),O([_({type:Object})],P.prototype,"rooms",2),O([_()],P.prototype,"initialRoom",2),O([_()],P.prototype,"controlMode",2),O([u()],P.prototype,"_selectedRoom",2),O([u()],P.prototype,"_rangeStart",2),O([u()],P.prototype,"_rangeEnd",2),O([u()],P.prototype,"_data",2),O([u()],P.prototype,"_chartAnchor",2),O([u()],P.prototype,"_loading",2),O([u()],P.prototype,"_hiddenSeries",2),O([u()],P.prototype,"_expandedStat",2),O([u()],P.prototype,"_chartInfoExpanded",2),O([u()],P.prototype,"_openDropdown",2),O([u()],P.prototype,"_activeQuick",2),P=O([Q("rs-analytics")],P);var hi=Object.defineProperty,pi=Object.getOwnPropertyDescriptor,A=(e,t,i,s)=>{for(var o=s>1?void 0:s?pi(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(o=(s?r(t,i,o):r(o))||o);return s&&o&&hi(t,i,o),o};const ui="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z",mi="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",gi="M16,11.78L20.24,4.45L21.97,5.45L16.74,14.5L10.23,10.75L5.46,19H22V21H2V3H4V17.54L9.5,8L16,11.78Z",_i="M15 13V5A3 3 0 0 0 9 5V13A5 5 0 1 0 15 13M12 4A1 1 0 0 1 13 5V8H11V5A1 1 0 0 1 12 4Z";let k=class extends N{constructor(){super(...arguments),this.narrow=!1,this.route={path:""},this.panel={},this._activeTab="areas",this._rooms={},this._roomsLoaded=!1,this._selectedAreaId=null,this._analyticsRoom="",this._vacationActive=!1,this._vacationTemp=null,this._vacationUntil=null,this._hiddenRooms=[],this._showHiddenRooms=!1,this._controlMode="bangbang",this._climateControlActive=!0,this._presenceEnabled=!1,this._anyoneHome=!0,this._presencePersons=[],this._presenceAwayAction="eco",this._saveStatus="idle",this._roomOrder=[],this._groupByFloor=!1,this._reorderMode=!1,this._elementsLoaded=!1,this._routeApplied=!1,this._areaInfosCache=[],this._onSaveStatus=e=>{e.stopPropagation(),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this._saveStatus=e.detail.status,e.detail.status==="saved"&&(this._saveStatusTimeout=setTimeout(()=>{this._saveStatus="idle"},2e3))}}connectedCallback(){super.connectedCallback(),ni().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener("save-status",this._onSaveStatus),this._routeApplied||(this._applyRoute(),this._routeApplied=!0)}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&(clearInterval(this._refreshInterval),this._refreshInterval=void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener("save-status",this._onSaveStatus)}render(){var o,a,r;if(!this._elementsLoaded)return l``;const e=this.hass.language,t=!!this._selectedAreaId,i=t?(a=(o=this.hass)==null?void 0:o.areas)==null?void 0:a[this._selectedAreaId]:null,s={areas:n("panel.tab.rooms",e),analytics:n("tabs.analytics",e),settings:n("panel.tab.settings",e)};return l`
    ...
    `}_renderTab(){switch(this._activeTab){case"areas":return this._renderAreas();case"analytics":return l`<rs-analytics
        ...
        ></rs-analytics>`;case"settings":return this._renderSettings();default:return h}}_renderAreas(){var c,d;if(this._selectedAreaId){const p=(d=(c=this.hass)==null?void 0:c.areas)==null?void 0:d[this._selectedAreaId];if(p){const m=this._rooms[this._selectedAreaId]??null;return l`
          <rs-room-detail
            .area=${p}
            .config=${m}
            .hass=${this.hass}
      ...
      `;const s=t.filter(p=>p.config).length,o=t.filter(p=>{var m,g;return((g=(m=p.config)==null?void 0:m.live)==null?void 0:g.mode)==="heating"}).length,a=t.filter(p=>{var m,g;return((g=(m=p.config)==null?void 0:m.live)==null?void 0:g.mode)==="cooling"}).length,r=this.hass.language;return l`
      ${s>0||i.length>0?l`
            ...
            <ha-card class="vacation-banner">
              <div class="vacation-content">
                ...
                <div class="vacation-text">
                  ...
                  <span class="vacation-detail">${n("vacation.banner_detail",this.hass.language,{temp:E(this._vacationTemp,this.hass),unit:v(this.hass),date:this._vacationUntil?new Date(this._vacationUntil*1e3).toLocaleString(this.hass.language,{dateStyle:"medium",timeStyle:"short"}):"—"})}</span>
                </div>
        ...
        <div class="area-grid">
          ${p.items.map((m,g)=>l`
              <rs-area-card
                .area=${m.area}
                .config=${m.config}
                .climateEntityCount=${m.climateEntityCount}
                .tempSensorCount=${m.tempSensorCount}
                .hass=${this.hass}
                .controlMode=${this._controlMode}
                .climateControlActive=${this._climateControlActive}
  ...
  `,A([_({attribute:!1})],k.prototype,"hass",2),A([_({type:Boolean,reflect:!0})],k.prototype,"narrow",2),A([_({type:Object})],k.prototype,"route",2),A([_({type:Object})],k.prototype,"panel",2),A([u()],k.prototype,"_activeTab",2),A([u()],k.prototype,"_rooms",2),A([u()],k.prototype,"_roomsLoaded",2),A([u()],k.prototype,"_selectedAreaId",2),A([u()],k.prototype,"_analyticsRoom",2),A([u()],k.prototype,"_vacationActive",2),A([u()],k.prototype,"_vacationTemp",2),A([u()],k.prototype,"_vacationUntil",2),A([u()],k.prototype,"_hiddenRooms",2),A([u()],k.prototype,"_showHiddenRooms",2),A([u()],k.prototype,"_controlMode",2),A([u()],k.prototype,"_climateControlActive",2),A([u()],k.prototype,"_presenceEnabled",2),A([u()],k.prototype,"_anyoneHome",2),A([u()],k.prototype,"_presencePersons",2),A([u()],k.prototype,"_presenceAwayAction",2),A([u()],k.prototype,"_saveStatus",2),A([u()],k.prototype,"_roomOrder",2),A([u()],k.prototype,"_groupByFloor",2),A([u()],k.prototype,"_reorderMode",2),A([u()],k.prototype,"_elementsLoaded",2),k=A([Q("roommind-panel")],k)})();
